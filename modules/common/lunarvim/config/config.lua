...
lvim.builtin.which_key.mappings["W"] = {
  name = "Workspaces",
  n = { '<cmd>WorkspacesOpen nvim<CR>' },
  s = { '<cmd>WorkspacesOpen show-new<CR>' }
}
lvim.builtin.which_key.mappings["g"]["v"] = { '<cmd>VGit project_diff_preview<CR>', "VGit" }
...
-- Tree config
lvim.builtin.nvimtree.open_on_setup = true
...
local options = {
  ...
  completeopt = 'menuone,preview,noinsert', -- mostly just for cmp
  conceallevel = 0, -- so that `` is visible in markdown files
  cursorline = true, -- highlight the current line
  expandtab = true, -- convert tabs to spaces
  fileencoding = "utf-8", -- the encoding written to a file
  guifont = "monospace:h17", -- the font used in graphical neovim applications
  hidden = true, -- allows hidden buffers. modified bufers don't need to be saved
  hlsearch = true, -- highlight all matches on previous search pattern
  ignorecase = true, -- ignore case in search patterns
  incsearch = true, -- start searching on each keystroke
  mouse = "nv", -- allow the mouse to be used in normal and visual modes
...
require("luasnip.loaders.from_vscode").load {
  paths = { "~/.config/lvim/snippets/simple-react-snippets" }
}
